...
export function identifyPdacreatorInstruction(
  instruction: { data: ReadonlyUint8Array } | ReadonlyUint8Array
): PdacreatorInstruction {
  ...
  if (
    ...
    return PdacreatorInstruction.Greet;
  }
  throw new Error(
    'The provided instruction could not be identified as a pdacreator instruction.'
  );
}
